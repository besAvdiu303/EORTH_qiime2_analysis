...
qiime taxa collapse \
  ...
  --o-collapsed-table 04-differential_abundance/${TAG}_gum-table-l${TAXA_COLLAPSE_LEVEL}.qza

qiime composition ancombc \
  --i-table 04-differential_abundance/${TAG}_gum-table-l${TAXA_COLLAPSE_LEVEL}.qza \
  --m-metadata-file $METADATA \
  --p-formula $METADATA_COLUMN3 \
  --p-reference-levels $METADATA_COLUMN3::$REF_LEVEL \
